...
namespace WindBot.Game.AI.Decks
{
    ...
    public class ToonExecutor : DefaultExecutor
    {
        ...
        public ToonExecutor(GameAI ai, Duel duel) : base(ai, duel)
        {
            ...
            AddExecutor(ExecutorType.Activate, CardId.Metaverse);

            AddExecutor(ExecutorType.Activate, CardId.ToonBriefcase);

            AddExecutor(ExecutorType.SpSummon, CardId.ToonCyberDragon);
            AddExecutor(ExecutorType.SpSummon, CardId.ToonMermaid);

            AddExecutor(ExecutorType.Summon, CardId.TheBlackStoneofLegend);
            AddExecutor(ExecutorType.SpSummon, CardId.ToonHarpieLady);
            AddExecutor(ExecutorType.Summon, CardId.ToonHarpieLady);
        ...
        {
            Logger.WriteLine($"ToonKingdom {ActivateDescription}");
        ...
        private bool ToonBookmarkEffect()
        {
            ...
            AI.SelectCard(
                        CardId.ToonPageFlip
                        ,CardId.ToonBriefcase
                        ,CardId.ToonBlackLusterSoldier
                        ,CardId.ToonTerror
                        ,CardId.ToonKingdom
                    );
            return true;
